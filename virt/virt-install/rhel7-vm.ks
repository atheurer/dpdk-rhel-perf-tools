...
url --url="http://download.eng.bos.redhat.com/released/RHEL-7/7.0/Server/x86_64/os/"
...
%post
echo 'http://download.devel.redhat.com/released/RHEL-7/7.1/Server/x86_64/os/' >/etc/yum.repos.d/rhel71.repo
yum update -y
